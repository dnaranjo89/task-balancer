        ...
        <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {state.people.map((person) => {
              const existingRating = task.ratings.find(r => r.personName === person.name);
              const currentRating = ratings[person.name] || existingRating?.points || 0;
              
              return (
                <div key={person.name} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        max="50"
                        value={currentRating}
                        onChange={(e) => handleRatingChange(person.name, parseInt(e.target.value))}
                    ...
                    <Button
                      ...
                      variant="primary"
                      size="small"
                      disabled={!ratings[person.name] || ratings[person.name] < 1}
                      className="w-full"
                    >
