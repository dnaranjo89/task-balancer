...
export function ExtraPointsControl({ completedTask, onSuccess }: ExtraPointsControlProps) {
  const [selectedPoints, setSelectedPoints] = useState<number>(completedTask.extraPoints);
